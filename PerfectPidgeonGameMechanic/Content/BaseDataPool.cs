...
namespace PerfectPidgeonGameMechanic.Content
{
    public class BaseDataPool
    {
        ...
        private void InitEnemies()
        {
            ...
            GV = new GroupVariant();
            GVE = new GroupVariantEntry();
            GVE.DesiredID = "TekitaiFighter";
            GVE.Offset = new Vertex(165, -5, 0);
            GV.Entries.Add(GVE);
            GVE = new GroupVariantEntry();
            GVE.DesiredID = "TekitaiFighter";
            GVE.Offset = new Vertex(-165, -5, 0);
            ...
            GE.Guns.Add(new Weapon(this._Weapons["TekitaiTrigunRight"]));
            this._Enemies.Add("TekitaiTrigun", GE);
            E = new Enemy();
            E.ArtIndex = 28;
            E.Facing = 0;
            E.Health = 30;
        ...
        private void InitBosses()
        {
            ...
            BO.AddAux(this.Enemies["AlienMothershipLeftWing"], new Vertex(-500, -35), 0);
            BO.AddAux(this.Enemies["AlienMothershipRightWing"], new Vertex(500, -35), 0);
        ...
        private void InitLevels()
        {
            ...
            L.SpawnStrategy = 1;
            L.Back = new Background("Data\\Town4", BackgroundType.Tiled, 2);
            L.Enemies.Add(new Grouped((Grouped)this._Enemies["TekitaiTrigun"]));
            L.Enemies.Add(new Grouped((Grouped)this._Enemies["TekitaiFighter"]));
            L.Enemies.Add(new Grouped((Grouped)this._Enemies["TekitaiFighter"]));
            L.Enemies.Add(new Enemy(this._Enemies["TekitaiNinja"]));
            L.Enemies.Add(new Enemy(this._Enemies["TekitaiNinja"]));
